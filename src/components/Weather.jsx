...
import sun from '../assets/1.png'
import sunCloudy from '../assets/2.png'
import cloudy from '../assets/3.png'
import cloudyRain from '../assets/4.png'
import sunRain from '../assets/5.png'
import rain from '../assets/6.png'
import snow from '../assets/7.png'
import sunWindy from '../assets/8.png'
import windy from '../assets/9.png'
import snowWindy from '../assets/10.png'
import rainWindy from '../assets/11.png'
...
function Weather() {
  ...
  const url = `https://api.openweathermap.org/data/2.5/forecast?q=${location}&appid=a75fa4e81bbc73ade3fed4006f33acd2`
  ...
  const searchLocation = () => {
    if (location !== '') {
      axios.get(url).then((response) => {
        ...
        console.log('5 ditet e ardhshme:', dailyForecasts)
            ...
            <div className="bg-white rounded-lg shadow-md">
              <div className="flex justify-between">
                ...
                <div className="py-3 px-13 flex ">
                  {weatherIcon.icon && (
                    <img src={weatherIcon.icon} alt="weather icon" width={90} />
                  )}
                  {/* <img src={weatherIcon.icon} alt="weather icon" width={100} /> */}
                  <div className="flex mt-5 pl-5 text-6xl font-bold">
                    {data.list?.[0]?.main?.temp ? (
                      <span>{Math.round(data.list[0].main.temp - 273.15)}</span>
                    ) : (
                      <p>Null</p>
                    )}
            ...
            <div className="bg-white rounded-lg shadow md mt-9 p-5">
              ...
              <div className="md:flex px-3">
                ...
                <div className="bg-gray-100 rounded-md mt-4 md:mx-8 w-full max-md:p-2">
                  ...
                  <div className="flex justify-center mt-2 mb-3">
                    <h1 className="text-md font-bold">
                      {data.list?.[0]?.wind?.speed || 'Null'} m/s
                    </h1>
                  </div>
                </div>
